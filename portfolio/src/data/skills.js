export const skills = [
    {name: 'Langauges & Frameworks',tags:['Python','JavaScripts','ReactJS','HTML5','CSS','BootStrap'],icon:'code'},
    {name: 'Python Libraries',tags:['Folium','Flask','Pandas','Jinja','FastAPI','Numpy'],icon:'python'},
